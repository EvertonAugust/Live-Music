                    ...
                    <div class="col-md-6 d-flex">
                        <div class="modal-body p-5 img d-flex align-items-center color-2">
                            <div class="text w-100 py-0 py-md-5">
                                <h3 style="font-weight:550 ;" class="mb-4">Cadastro</h3>
                                <form action="#" class="signup-form">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="password" class="form-control" placeholder="Digite novamente sua senha">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <button style="font-weight:bold ;" type="submit" class="form-control btn btn-primary rounded submit px-3">Confirmar Cadastro</button>
                                    </div>
                                </form>
